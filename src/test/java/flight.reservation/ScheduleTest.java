...
public class ScheduleTest {
    ...
    class GivenAnEmptySchedule {
        ...
        void thenScheduleShouldYieldEmpty() {
            schedule.removeFlight(new Flight(1, new Airport("a", "a", "a"), new Airport("b", "b", "b"), new A380Plane()));
            assertEquals(0, schedule.getScheduledFlights().size());
        }
        ...
        class WhenAFlightIsScheduled {
            ...
            void scheduleOneFlight() {
                ...
                IAircraft aircraft = new A380Plane();
    ...
    class GivenAnExistingSchedule {
        ...
        List<Flight> flights = Arrays.asList(
                new Flight(1, airports.get(0), airports.get(1), new A350Plane()),
                new Flight(2, airports.get(1), airports.get(2), new A380Plane()),
                new Flight(3, airports.get(2), airports.get(4), new Embraer190Plane()),
                new Flight(4, airports.get(3), airports.get(2), new AntonovAN2Plane()),
                new Flight(5, airports.get(4), airports.get(2), new H1Helicopter()),
                new Flight(6, airports.get(5), airports.get(7), new HypaHypePassengerDrone())
        );
