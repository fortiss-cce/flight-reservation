        ...
        class FlightIsPossible {
            ...
            class H1FullyBooked {
                ...
                void thenTheBookingShouldBeStopped() throws NoSuchFieldException {
                    ...
                    assertThrows(IllegalStateException.class, () -> FlightOrder.createOrder(customer, Arrays.asList(scheduledFlight), 100));
            ...
            class H1Empty {
                ...
                void thenTheBookingShouldSucceed() throws NoSuchFieldException {
                    ScheduledFlight scheduledFlight = schedule.searchScheduledFlight(flight.getNumber());
                    scheduledFlight.addPassengers(Arrays.asList(new Passenger("Amanda")));
                    FlightOrder order = FlightOrder.createOrder(customer, Arrays.asList(scheduledFlight), 100);
    ...
    class CustomerOnePassengerCreditCardPayment {
        ...
        class CreditCardValid {
            ...
            void thenTheBookingShouldSucceed() throws NoSuchFieldException {
                ...
                assertEquals("Max Mustermann", scheduledFlight.getPassengers().get(0).getName());
