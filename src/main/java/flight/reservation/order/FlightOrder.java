...
public class FlightOrder extends Order {
    ...
    public static FlightOrder create(Customer customer,
    ...
    private static boolean isOrderValid(Customer customer, List<String> passengerNames, List<ScheduledFlight> flights) {
        boolean valid = true;
